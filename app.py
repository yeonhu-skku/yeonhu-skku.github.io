...
# ============================================================
    ...
    <div class="section-header">
        <div class="section-icon">📊</div>
        <h3 style="margin:0;">Running Analytics</h3>
    </div>
    """, unsafe_allow_html=True)
    ...
    selected_course = filtered_df.iloc[0]
    ...
    radar_df = pd.DataFrame({
        ...
        "Score": [
            min(selected_course["Distance_KM"] * 5, 100),
            min(selected_course["Elevation_Gain"] / 3, 100),
            selected_course["Water_Fountains"] * 6,
            80 if selected_course["Shade_Level"] == "High" else 50,
            90 if selected_course["Surface"] == "Paved" else 60
        ]
    })
